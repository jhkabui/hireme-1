...
job1 = Job.create!(
  ...
  location: "Berlin",
  description: "Help us to make mobile apps and web development as easy as it can be across Zalando by creating a scalable development platform to enable engineers and product managers across the group to focus on solving customer problems and building amazing digital experiences. Enable the management of events about customer actions and behaviours to further optimize the user experience.
...
Collaborate with Product Managers, Data Scientists and Engineers to define what personalised and customised experience should be on Zalando. You'll inspire the organization with your ability to create a customer experience vision and tell a compelling business story (with the customer as the hero).
...
job5 = Job.create!(
  title: "Marketing Manager PL",
  location: "Berlin",
  description: "In this Berlin-based role, as a (Sr.) Marketing Manager for Poland, you will focus on further developing this company as the primary destination for fashion and lifestyle in Poland. You will manage all local marketing activities with the aim of further strengthening the Zalando brand in PL as well as driving relevant traffic to our local site and app.
